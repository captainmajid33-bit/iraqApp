  ...
  return (
    <div>
      <div style={{ display: "flex", gap: "12px", flexWrap: "wrap", marginBottom: "12px", alignItems: "center" }}>
        ...
        <span style={{ color: C.dim, fontFamily: "Rajdhani, sans-serif", fontSize: "13px" }}>↕ اسحب المواقع لتحديثها · <span style={{ color: "#ff2d78" }}>تاكسي/غاز: GPS حي فقط — التحريك معطّل</span></span>
